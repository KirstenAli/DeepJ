...
public class DeepJPrismTest {
    ...
    void config_rejectsInvalidCommonParams() {
        assertThrows(IllegalArgumentException.class,
                () -> new DeepJPrismConfig(0, 16, 32, 4, 2, 64, 16, 8));
        assertThrows(IllegalArgumentException.class,
                () -> new DeepJPrismConfig(256, 16, 33, 4, 2, 64, 16, 8));
        assertThrows(IllegalArgumentException.class,
                () -> new DeepJPrismConfig(256, 16, 6, 2, 2, 64, 4, 2));
    }

    @Test
    void config_rejectsInvalidRanks() {
        assertThrows(IllegalArgumentException.class,
                () -> new DeepJPrismConfig(256, 16, 32, 4, 2, 64, 0, 8));
        assertThrows(IllegalArgumentException.class,
                () -> new DeepJPrismConfig(256, 16, 32, 4, 2, 64, 16, 0));
    }
    ...
    void configIncludesStableTrainingDefaults() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new DeepJPrismConfig(11, 8, 4, 2, 1, 8, 3, 2, 0.0f, 1.0f));
    }
