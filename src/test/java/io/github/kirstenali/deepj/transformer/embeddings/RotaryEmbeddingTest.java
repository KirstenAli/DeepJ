...
class RotaryEmbeddingTest {
    ...
    void cos_sin_first_dim_at_position_one_are_cos1_sin1() {
        ...
        Tensor x = new Tensor(new double[][]{{1.0, 0.0, 0.0, 0.0},   // pos 0
    ...
    void rotation_is_norm_preserving() {
        ...
        Tensor x = new Tensor(new double[][]{{3.0, 4.0, 1.0, 2.0},   // pos 0
        ...
        for (int r = 0; r < x.rows; r++) {
            ...
            assertEquals(normX, normY, 1e-9, "Norm should be preserved at row " + r);
        }
    }
    ...
    void apply_then_applyBackward_is_identity() {
        ...
        TestSupport.assertTensorAllClose(x, recovered, 1e-10);
    }
    ...
    void applyBackward_then_apply_is_identity() {
        ...
        TestSupport.assertTensorAllClose(x, back, 1e-10);
    }
    ...
    void multi_head_rotation_each_head_sees_same_positions() {
        ...
        Tensor xSingle = new Tensor(rowData);              // 1 head, seqLen=2
        Tensor xDouble = new Tensor(new double[][]{        // 2 heads, seqLen=2
