...
public final class ExportDeepJPrismTinyStories {
    ...
    static Path export(Path output, Path checkpoint, Path bundle, Path validation,
        ...
        var artifacts = DeepJPrismTinyStoriesArtifacts.load(output, checkpoint);
    ...
    private static void verify(Path bundle, DeepJPrismTinyStoriesArtifacts.Loaded artifacts)
            throws Exception {
    ...
    private static ModelCard modelCard(DeepJPrismTinyStoriesArtifacts.Loaded artifacts,
    ...
    private static long parameterCount(DeepJPrismTinyStoriesArtifacts.Loaded artifacts) {
