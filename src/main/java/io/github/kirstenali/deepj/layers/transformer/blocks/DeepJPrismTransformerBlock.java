...
public final class DeepJPrismTransformerBlock extends AbstractTransformerBlock {

    public DeepJPrismTransformerBlock(int dModel, int nHeads, int qRank, int kvRank,
